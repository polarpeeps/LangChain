...
# result = runnable_word_count.invoke("Hi how are you")
# print(result) #4
...
print(result)
#{'joke': 'Why did the soccer player bring string to the FIFA game?\n\nBecause he heard they were playing with a tight deadline!',
#  'word_count': 21}